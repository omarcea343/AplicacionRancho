    ...
    return (
        <SafeAreaView style={styles.container}>
          <ScrollView style={styles.scroll}>
            ...
            <Text style={styles.txtTitle}>Eliminar Tipo de Animal</Text>
            <Text style={styles.insText}>Ingrese el ID del tipo de animal a eliminar:</Text>
            <Input
              value={idTipoAnim}
              style={styles.input}
      ...
      function validoYenvio() {
        if (idTipoAnim === '' ) {
            ...
            if(!isNaN(idTipoAnimf) && idTipoAnimf != 0){
                fetch(`http://${ip}/tipoAnimales/delete-tipo_animal/` + idTipoAnimf,{
                    method: 'DELETE',
                  })
...
const styles = StyleSheet.create({
  ...
  export default ElimTipoAnim_Screen;