...
const ElimCompra_Screen = () => {
  ...
  const [idCompraf, setIdCompraf] = useState(0);
    ...
    return (
        <SafeAreaView style={styles.container}>
          <ScrollView style={styles.scroll}>
            ...
            <Text style={styles.txtTitle}>Eliminar Compra</Text>
            <Text style={styles.insText}>Ingrese el ID de la compra a eliminar:</Text>
            <Input
              value={idCompra}
              style={styles.input}
            ...
            <TouchableOpacity style={styles.btn} onPress={() => validoYenvio()}>
              <Text style={styles.text}>Eliminar Compra</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  export default ElimCompra_Screen;