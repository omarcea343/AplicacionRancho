...
const ElimDireccion_Screen = () => {
  ...
  const [idDirf, setIdDirf] = useState(0);
    ...
    return (
        <SafeAreaView style={styles.container}>
          <ScrollView style={styles.scroll}>
            ...
            <Text style={styles.txtTitle}>Eliminar Dirección</Text>
            <Text style={styles.insText}>Ingrese el ID de la dirección a eliminar:</Text>
            <Input
              value={idDir}
              style={styles.input}
            ...
            <TouchableOpacity style={styles.btn} onPress={() => validoYenvio()}>
              <Text style={styles.text}>Eliminar Dirección</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  export default ElimDireccion_Screen;