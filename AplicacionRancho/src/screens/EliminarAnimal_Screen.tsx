    ...
    return (
        <SafeAreaView style={styles.container}>
          <ScrollView style={styles.scroll}>
            ...
            <Text style={styles.txtTitle}>Eliminar Animal</Text>
            <Text style={styles.insText}>Ingrese el ID del animal a eliminar:</Text>
            <Input
              value={idAnimal}
              style={styles.input}
            ...
            <TouchableOpacity style={styles.btn} onPress={() => validoYenvio()}>
              <Text style={styles.text}>Eliminar Animal</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  export default ElimAnimal_Screen;